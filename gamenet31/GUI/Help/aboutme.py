...
## Class MyPanel1
###########################################################################
txt = u""" اين برنامه توسط پويا قيامي نوشته شده و در آن از کتابخانه
           wxpython sqlite3
           استفاده شده است شما ميتوانيد براي توسعه و تهيه اين برنامه
           با شماره تلفن 09183303936 و يا با تلگرام به همين شماره
           درخواست هاي خود را الان نمائيد
           با تشکر پويا قيامي
...
class MyPanel1 ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_button1 = wx.Button( self, wx.ID_ANY, u"قبول", wx.DefaultPosition, wx.DefaultSize, 0 )
